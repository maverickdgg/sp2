...
void LoadingScene::RenderMesh(Mesh* mesh, bool enableLight)
{
...
void LoadingScene::RenderText(Mesh* mesh, std::string text, Color color)
{
...
void LoadingScene::RenderMeshOnScreen(Mesh* mesh, Vector3 translate, Vector3 scale, Vector3 rotate)
{
	Mtx44 ortho;
...
void LoadingScene::Renderfps()
{
	...
	RenderMeshOnScreen(meshList[GEO_QUAD], Vector3(0, 0, 0), Vector3(10, 10, 10), Vector3(0, 0, 0));
	/*<---Weapons--->*/

}

void LoadingScene::Rendertps()
{
